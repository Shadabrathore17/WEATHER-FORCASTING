...
// Replace the OpenWeatherMap API call with the backend API call
...
search.addEventListener('click', () => {
    ...
    // Fetch weather data from the backend (which handles API calls)
    fetch(`${backendUrl}/weather?city=${city}`)
...
// Button event listeners for forecast
document.getElementById('today-forecast-btn').addEventListener('click', function () {
    ...
    // Fetch today's forecast data here!
});
...
document.getElementById('five-day-forecast-btn').addEventListener('click', function () {
    ...
    // Fetch 5-day forecast data here!
});
